...
class AhtapotEn extends StatefulWidget {
  const AhtapotEn({Key? key}) : super(key: key);

  @override
  _AhtapotEnState createState() => _AhtapotEnState();
}

class _AhtapotEnState extends State<AhtapotEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('OCTOPUS',style: TextStyle(fontWeight: FontWeight.bold,
