...
import 'package:abcegitim/AkrepTr.dart';
import 'package:abcegitim/anasayfa.dart';
import 'package:flutter/material.dart';

import 'AkrepEng.dart';

class AhtapotEng extends StatefulWidget {
  const AhtapotEng({Key? key}) : super(key: key);

  @override
  _AhtapotEngState createState() => _AhtapotEngState();
}

class _AhtapotEngState extends State<AhtapotEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: const AssetImage('assets/images/o.png'),),
              onTap: (){player.play('a.mp3');},
            ),
