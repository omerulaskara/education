...
class AhtapotTr extends StatefulWidget {
  const AhtapotTr({Key? key}) : super(key: key);

  @override
  _AhtapotTrState createState() => _AhtapotTrState();
}

class _AhtapotTrState extends State<AhtapotTr> {
