...
class AkrepEn extends StatefulWidget {
  const AkrepEn({Key? key}) : super(key: key);

  @override
  _AkrepEnState createState() => _AkrepEnState();
}

class _AkrepEnState extends State<AkrepEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/akrep.png'),),
          ...
          Container(
              ...
              child: const Text('SCORPİON',style: TextStyle(fontWeight: FontWeight.bold,
