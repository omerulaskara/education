...
class AriEn extends StatefulWidget {
  const AriEn({Key? key}) : super(key: key);

  @override
  _AriEnState createState() => _AriEnState();
}

class _AriEnState extends State<AriEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('BEE',style: TextStyle(fontWeight: FontWeight.bold,
