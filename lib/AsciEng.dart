...
import 'package:abcegitim/DoktorEng.dart';
import 'package:abcegitim/PolisEng.dart';
import 'package:flutter/material.dart';
import 'anasayfa.dart';

class AsciEng extends StatefulWidget {
  const AsciEng({Key? key}) : super(key: key);

  @override
  _AsciEngState createState() => _AsciEngState();
}

class _AsciEngState extends State<AsciEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/asci.png'),),
          ...
          Container(
              ...
              child: const Text('CHEF',style: TextStyle(fontWeight: FontWeight.bold,
