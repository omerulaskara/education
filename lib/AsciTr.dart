...
import 'package:abcegitim/DoktorTr.dart';
import 'package:abcegitim/PolisTr.dart';
import 'package:flutter/material.dart';
import 'anasayfa.dart';

class AsciTr extends StatefulWidget {
  const AsciTr({Key? key}) : super(key: key);

  @override
  _AsciTrState createState() => _AsciTrState();
}

class _AsciTrState extends State<AsciTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('AŞÇI',style: TextStyle(fontWeight: FontWeight.bold,
