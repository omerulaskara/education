...
import 'AtEn.dart';
class AslanEn extends StatefulWidget {
  const AslanEn({Key? key}) : super(key: key);

  @override
  _AslanEnState createState() => _AslanEnState();
}

class _AslanEnState extends State<AslanEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Aslan.png'),),
          ...
          Container(
              ...
              child: const Text('LİON',style: TextStyle(fontWeight: FontWeight.bold,
