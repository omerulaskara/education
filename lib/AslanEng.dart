...
class AslanEng extends StatefulWidget {
  const AslanEng({Key? key}) : super(key: key);

  @override
  _AslanEngState createState() => _AslanEngState();
}

class _AslanEngState extends State<AslanEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: const AssetImage('assets/images/l.png'),),
              onTap: (){player.play('a.mp3');},
            ),
