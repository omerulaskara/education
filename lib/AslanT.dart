...
class AslanT extends StatefulWidget {
  const AslanT({Key? key}) : super(key: key);

  @override
  _AslanTState createState() => _AslanTState();
}

class _AslanTState extends State<AslanT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'ASLAN', style: TextStyle(fontWeight: FontWeight.bold,
