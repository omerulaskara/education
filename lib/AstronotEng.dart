...
import 'MuzisyenEng.dart';
import 'RessamEng.dart';
import 'anasayfa.dart';

class AstronotEng extends StatefulWidget {
  const AstronotEng({Key? key}) : super(key: key);

  @override
  _AstronotEngState createState() => _AstronotEngState();
}

class _AstronotEngState extends State<AstronotEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('ASTRONAUT',style: TextStyle(fontWeight: FontWeight.bold,
