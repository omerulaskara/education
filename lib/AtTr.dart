...
class AtTrTr extends StatefulWidget {
  const AtTrTr({Key? key}) : super(key: key);

  @override
  _AtTrTrState createState() => _AtTrTrState();
}

class _AtTrTrState extends State<AtTrTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/at.png'),),
          ...
          Container(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/a.png'),),
              onTap: (){player.play('a.mp3');},
            ),
