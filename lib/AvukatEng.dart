...
class AvukatEng extends StatefulWidget {
  const AvukatEng({Key? key}) : super(key: key);

  @override
  _AvukatEngState createState() => _AvukatEngState();
}

class _AvukatEngState extends State<AvukatEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('LAWYER',style: TextStyle(fontWeight: FontWeight.bold,
