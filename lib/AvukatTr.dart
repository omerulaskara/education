import 'package:abcegitim/HakimTr.dart';
...
class AvukatTr extends StatefulWidget {
  const AvukatTr({Key? key}) : super(key: key);

  @override
  _AvukatTrState createState() => _AvukatTrState();
}

class _AvukatTrState extends State<AvukatTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/avukat.png'),),
          ...
          SizedBox(
              ...
              child: const Text('AVUKAT',style: TextStyle(fontWeight: FontWeight.bold,
