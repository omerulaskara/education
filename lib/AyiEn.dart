...
class AyiEn extends StatefulWidget {
  const AyiEn({Key? key}) : super(key: key);

  @override
  _AyiEnState createState() => _AyiEnState();
}

class _AyiEnState extends State<AyiEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Ayi.png'),),
          ...
          Container(
              ...
              child: const Text('BEAR',style: TextStyle(fontWeight: FontWeight.bold,
