...
import 'package:abcegitim/AtTr.dart';
...
class AyiEng extends StatefulWidget {
  const AyiEng({Key? key}) : super(key: key);

  @override
  _AyiEngState createState() => _AyiEngState();
}

class _AyiEngState extends State<AyiEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/ayi.png'),),
