...
class BalikEn extends StatefulWidget {
  const BalikEn({Key? key}) : super(key: key);

  @override
  _BalikEnState createState() => _BalikEnState();
}

class _BalikEnState extends State<BalikEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Balik.png'),),
          ...
          Container(
              ...
              child: const Text('FİSH',style: TextStyle(fontWeight: FontWeight.bold,
