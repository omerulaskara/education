...
class BalikT extends StatefulWidget {
  const BalikT({Key? key}) : super(key: key);

  @override
  _BalikTState createState() => _BalikTState();
}

class _BalikTState extends State<BalikT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'BALIK', style: TextStyle(fontWeight: FontWeight.bold,
