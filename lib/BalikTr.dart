...
class BalikTr extends StatefulWidget {
  const BalikTr({Key? key}) : super(key: key);

  @override
  _BalikTrState createState() => _BalikTrState();
}

class _BalikTrState extends State<BalikTr> {
