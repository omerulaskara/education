...
class BalinaEn extends StatefulWidget {
  const BalinaEn({Key? key}) : super(key: key);

  @override
  _BalinaEnState createState() => _BalinaEnState();
}

class _BalinaEnState extends State<BalinaEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Balina.png'),),
          ...
          Container(
              ...
              child: const Text('WHALE',style: TextStyle(fontWeight: FontWeight.bold,
