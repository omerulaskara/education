...
import 'BalikEng.dart';
import 'BalikTr.dart';
import 'BaykusEng.dart';
import 'BaykusTr.dart';

class BalinaEng extends StatefulWidget {
  const BalinaEng({Key? key}) : super(key: key);

  @override
  _BalinaEngState createState() => _BalinaEngState();
}

class _BalinaEngState extends State<BalinaEng> {
