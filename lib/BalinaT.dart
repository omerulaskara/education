...
class BalinaT extends StatefulWidget {
  const BalinaT({Key? key}) : super(key: key);

  @override
  _BalinaTState createState() => _BalinaTState();
}

class _BalinaTState extends State<BalinaT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'BALİNA', style: TextStyle(fontWeight: FontWeight.bold,
