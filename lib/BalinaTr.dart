...
class BalinaTr extends StatefulWidget {
  const BalinaTr({Key? key}) : super(key: key);

  @override
  _BalinaTrState createState() => _BalinaTrState();
}

class _BalinaTrState extends State<BalinaTr> {
