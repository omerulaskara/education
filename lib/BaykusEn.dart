...
import 'BalinaEn.dart';
import 'CeylanEn.dart';
import 'anasayfa.dart';

class BaykusEn extends StatefulWidget {
  const BaykusEn({Key? key}) : super(key: key);

  @override
  _BaykusEnState createState() => _BaykusEnState();
}

class _BaykusEnState extends State<BaykusEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Baykus.png'),),
          ...
          Container(
              ...
              child: const Text('OWL',style: TextStyle(fontWeight: FontWeight.bold,
