...
import 'BalinaEng.dart';
import 'BalinaTr.dart';
import 'CeylanEng.dart';
import 'CeylanTr.dart';

class BaykusEng extends StatefulWidget {
  const BaykusEng({Key? key}) : super(key: key);

  @override
  _BaykusEngState createState() => _BaykusEngState();
}

class _BaykusEngState extends State<BaykusEng> {
