...
class BaykusT extends StatefulWidget {
  const BaykusT({Key? key}) : super(key: key);

  @override
  _BaykusTState createState() => _BaykusTState();
}

class _BaykusTState extends State<BaykusT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'BAYKUS', style: TextStyle(fontWeight: FontWeight.bold,
