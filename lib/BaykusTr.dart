...
import 'BalinaTr.dart';
import 'CeylanTr.dart';

class BaykusTr extends StatefulWidget {
  const BaykusTr({Key? key}) : super(key: key);

  @override
  _BaykusTrState createState() => _BaykusTrState();
}

class _BaykusTrState extends State<BaykusTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/b.png'),),
              onTap: (){player.play('a.mp3');},
            ),
