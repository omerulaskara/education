...
class BesTr extends StatefulWidget {
  const BesTr({Key? key}) : super(key: key);

  @override
  _BesTrState createState() => _BesTrState();
}

class _BesTrState extends State<BesTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/bes.png'),),
          ...
          SizedBox(
              ...
              child: const Text('BEŞ',style: TextStyle(fontWeight: FontWeight.bold,
