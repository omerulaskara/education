...
class BirTr extends StatefulWidget {
  const BirTr({Key? key}) : super(key: key);

  @override
  _BirTrState createState() => _BirTrState();
}

class _BirTrState extends State<BirTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/bir.png'),),
          ...
          SizedBox(
              ...
              child: const Text('BİR',style: TextStyle(fontWeight: FontWeight.bold,
