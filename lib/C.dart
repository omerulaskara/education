...
import 'package:abcegitim/CC.dart';
import 'package:abcegitim/anasayfa.dart';
import 'package:flutter/material.dart';

class Ctr extends StatefulWidget {
  const Ctr({Key? key}) : super(key: key);

  @override
  _CtrState createState() => _CtrState();
}

class _CtrState extends State<Ctr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/c.png'),fit: BoxFit.fitWidth,),
              onTap: (){player.play('c.mp3');},
            ),
