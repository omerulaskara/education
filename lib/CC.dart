...
class CCtr extends StatefulWidget {
  const CCtr({Key? key}) : super(key: key);

  @override
  _CCtrState createState() => _CCtrState();
}

class _CCtrState extends State<CCtr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/cc.png'),),
              onTap: (){player.play('cc.mp3');},
            ),
