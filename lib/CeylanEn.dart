...
import 'BaykusEn.dart';
import 'DeveEn.dart';
import 'anasayfa.dart';

class CeylanEn extends StatefulWidget {
  const CeylanEn({Key? key}) : super(key: key);

  @override
  _CeylanEnState createState() => _CeylanEnState();
}

class _CeylanEnState extends State<CeylanEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/ceylan.png'),),
          ...
          Container(
              ...
              child: const Text('GAZELLE',style: TextStyle(fontWeight: FontWeight.bold,
