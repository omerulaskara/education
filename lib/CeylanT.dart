...
class CeylanT extends StatefulWidget {
  const CeylanT({Key? key}) : super(key: key);

  @override
  _CeylanTState createState() => _CeylanTState();
}

class _CeylanTState extends State<CeylanT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'CEYLAN', style: TextStyle(fontWeight: FontWeight.bold,
