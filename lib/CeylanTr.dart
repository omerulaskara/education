...
import 'BaykusTr.dart';
import 'DeveTr.dart';

class CeylanTr extends StatefulWidget {
  const CeylanTr({Key? key}) : super(key: key);

  @override
  _CeylanTrState createState() => _CeylanTrState();
}

class _CeylanTrState extends State<CeylanTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/c.png'),),
              onTap: (){player.play('a.mp3');},
            ),
