...
import 'ItfaiyeciEng.dart';
import 'RessamEng.dart';
import 'anasayfa.dart';

class CiftciEng extends StatefulWidget {
  const CiftciEng({Key? key}) : super(key: key);

  @override
  _CiftciEngState createState() => _CiftciEngState();
}

class _CiftciEngState extends State<CiftciEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/ciftci.png'),),
          ...
          SizedBox(
              ...
              child: const Text('FARMER',style: TextStyle(fontWeight: FontWeight.bold,
