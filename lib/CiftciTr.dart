...
import 'ItfaiyeciTr.dart';
import 'RessamTr.dart';
import 'anasayfa.dart';

class CiftciTr extends StatefulWidget {
  const CiftciTr({Key? key}) : super(key: key);

  @override
  _CiftciTrState createState() => _CiftciTrState();
}

class _CiftciTrState extends State<CiftciTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('ÇİFTÇİ',style: TextStyle(fontWeight: FontWeight.bold,
