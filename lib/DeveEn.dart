...
class DeveEn extends StatefulWidget {
  const DeveEn({Key? key}) : super(key: key);

  @override
  _DeveEnState createState() => _DeveEnState();
}

class _DeveEnState extends State<DeveEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('CAMEL',style: TextStyle(fontWeight: FontWeight.bold,
