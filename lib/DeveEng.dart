...
class DeveEng extends StatefulWidget {
  const DeveEng({Key? key}) : super(key: key);

  @override
  _DeveEngState createState() => _DeveEngState();
}

class _DeveEngState extends State<DeveEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/deve.png'),),
