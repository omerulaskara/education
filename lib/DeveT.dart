...
class DeveT extends StatefulWidget {
  const DeveT({Key? key}) : super(key: key);

  @override
  _DeveTState createState() => _DeveTState();
}

class _DeveTState extends State<DeveT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'DEVE', style: TextStyle(fontWeight: FontWeight.bold,
