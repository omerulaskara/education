...
class DeveTr extends StatefulWidget {
  const DeveTr({Key? key}) : super(key: key);

  @override
  _DeveTrState createState() => _DeveTrState();
}

class _DeveTrState extends State<DeveTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/d.png'),),
              onTap: (){player.play('a.mp3');},
            ),
