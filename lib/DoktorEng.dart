...
import 'package:abcegitim/AsciEng.dart';
import 'package:flutter/material.dart';
import 'OgretmenEng.dart';
import 'anasayfa.dart';

class DoktorEng extends StatefulWidget {
  const DoktorEng({Key? key}) : super(key: key);

  @override
  _DoktorEngState createState() => _DoktorEngState();
}

class _DoktorEngState extends State<DoktorEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('DOCTOR',style: TextStyle(fontWeight: FontWeight.bold,
