...
import 'package:abcegitim/AsciTr.dart';
import 'package:flutter/material.dart';
import 'OgretmenTr.dart';
import 'anasayfa.dart';

class DoktorTr extends StatefulWidget {
  const DoktorTr({Key? key}) : super(key: key);

  @override
  _DoktorTrState createState() => _DoktorTrState();
}

class _DoktorTrState extends State<DoktorTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/doktor.png'),),
          ...
          SizedBox(
              ...
              child: const Text('DOKTOR',style: TextStyle(fontWeight: FontWeight.bold,
