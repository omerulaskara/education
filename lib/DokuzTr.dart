...
class DokuzTr extends StatefulWidget {
  const DokuzTr({Key? key}) : super(key: key);

  @override
  _DokuzTrState createState() => _DokuzTrState();
}

class _DokuzTrState extends State<DokuzTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/dokuz.png'),),
          ...
          SizedBox(
              ...
              child: const Text('DOKUZ',style: TextStyle(fontWeight: FontWeight.bold,
