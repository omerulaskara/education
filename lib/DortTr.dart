...
class DortTr extends StatefulWidget {
  const DortTr({Key? key}) : super(key: key);

  @override
  _DortTrState createState() => _DortTrState();
}

class _DortTrState extends State<DortTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('DÖRT',style: TextStyle(fontWeight: FontWeight.bold,
