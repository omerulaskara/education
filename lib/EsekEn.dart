...
class EsekEn extends StatefulWidget {
  const EsekEn({Key? key}) : super(key: key);

  @override
  _EsekEnState createState() => _EsekEnState();
}

class _EsekEnState extends State<EsekEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('DONKEY',style: TextStyle(fontWeight: FontWeight.bold,
