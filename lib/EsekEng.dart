...
class EssekEng extends StatefulWidget {
  const EssekEng({Key? key}) : super(key: key);

  @override
  _EssekEngState createState() => _EssekEngState();
}

class _EssekEngState extends State<EssekEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/esek.png'),),
          ...
          SizedBox(
            height: screenheight/4,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/m.png'),),
              onTap: (){player.play('a.mp3');},
            ),
