...
class EsekT extends StatefulWidget {
  const EsekT({Key? key}) : super(key: key);

  @override
  _EsekTState createState() => _EsekTState();
}

class _EsekTState extends State<EsekT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'EŞEK', style: TextStyle(fontWeight: FontWeight.bold,
