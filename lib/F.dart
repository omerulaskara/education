...
import 'package:abcegitim/E.dart';
import 'package:abcegitim/G.dart';
import 'package:abcegitim/anasayfa.dart';
import 'package:flutter/material.dart';

class Ftr extends StatefulWidget {
  const Ftr({Key? key}) : super(key: key);

  @override
  _FtrState createState() => _FtrState();
}

class _FtrState extends State<Ftr> {
