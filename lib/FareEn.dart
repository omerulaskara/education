...
class FareEn extends StatefulWidget {
  const FareEn({Key? key}) : super(key: key);

  @override
  _FareEnState createState() => _FareEnState();
}

class _FareEnState extends State<FareEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Fare.png'),),
          ...
          Container(
              ...
              child: const Text('MOUSE',style: TextStyle(fontWeight: FontWeight.bold,
