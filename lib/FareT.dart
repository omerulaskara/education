...
class FareT extends StatefulWidget {
  const FareT({Key? key}) : super(key: key);

  @override
  _FareTState createState() => _FareTState();
}

class _FareTState extends State<FareT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'FARE', style: TextStyle(fontWeight: FontWeight.bold,
