...
import 'FareEn.dart';
import 'GergedanEn.dart';
import 'anasayfa.dart';

class FilEn extends StatefulWidget {
  const FilEn({Key? key}) : super(key: key);

  @override
  _FilEnState createState() => _FilEnState();
}

class _FilEnState extends State<FilEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Fil.png'),),
          ...
          Container(
              ...
              child: const Text('FİL',style: TextStyle(fontWeight: FontWeight.bold,
