...
class GGtr extends StatefulWidget {
  const GGtr({Key? key}) : super(key: key);

  @override
  _GGtrState createState() => _GGtrState();
}

class _GGtrState extends State<GGtr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/gg.png'),),
              onTap: (){player.play('gg.mp3');},
            ),
