...
import 'package:abcegitim/%C4%B0nekEn.dart';

import 'AstronotEng.dart';
import 'FilEn.dart';
import 'anasayfa.dart';

class GergedanEn extends StatefulWidget {
  const GergedanEn({Key? key}) : super(key: key);

  @override
  _GergedanEnState createState() => _GergedanEnState();
}

class _GergedanEnState extends State<GergedanEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/Gergedan.png'),),
          ...
          Container(
              ...
              child: const Text('RHİNO',style: TextStyle(fontWeight: FontWeight.bold,
