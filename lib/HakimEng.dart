...
class HakimEng extends StatefulWidget {
  const HakimEng({Key? key}) : super(key: key);

  @override
  _HakimEngState createState() => _HakimEngState();
}

class _HakimEngState extends State<HakimEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/hakim.png'),),
          ...
          SizedBox(
              ...
              child: const Text('JUDGE',style: TextStyle(fontWeight: FontWeight.bold,
