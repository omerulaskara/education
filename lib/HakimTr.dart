...
class HakimTr extends StatefulWidget {
  const HakimTr({Key? key}) : super(key: key);

  @override
  _HakimTrState createState() => _HakimTrState();
}

class _HakimTrState extends State<HakimTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('HAKİM',style: TextStyle(fontWeight: FontWeight.bold,
