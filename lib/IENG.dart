...
import 'HENG.dart';
import 'JENG.dart';
class Ieng extends StatefulWidget {
  const Ieng({Key? key}) : super(key: key);

  @override
  _IengState createState() => _IengState();
}

class _IengState extends State<Ieng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/i2.png'),),
              onTap: (){player.play('ien.mp3');},
            ),
