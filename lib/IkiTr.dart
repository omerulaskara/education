...
class IkiTr extends StatefulWidget {
  const IkiTr({Key? key}) : super(key: key);

  @override
  _IkiTrState createState() => _IkiTrState();
}

class _IkiTrState extends State<IkiTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/iki.png'),),
          ...
          SizedBox(
              ...
              child: const Text('İKİ',style: TextStyle(fontWeight: FontWeight.bold,
