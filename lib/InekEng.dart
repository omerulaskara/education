...
import 'GergedanEng.dart';
import 'KaplanEng.dart';

class InekEng extends StatefulWidget {
  const InekEng({Key? key}) : super(key: key);

  @override
  _InekEngState createState() => _InekEngState();
}

class _InekEngState extends State<InekEng> {
