...
import 'package:abcegitim/okulEng.dart';

import 'AstronotEng.dart';
import 'anasayfa.dart';
import 'bankEng.dart';

class ItfaEng extends StatefulWidget {
  const ItfaEng({Key? key}) : super(key: key);

  @override
  _ItfaEngState createState() => _ItfaEngState();
}

class _ItfaEngState extends State<ItfaEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('FİRE STATION',style: TextStyle(fontWeight: FontWeight.bold,
