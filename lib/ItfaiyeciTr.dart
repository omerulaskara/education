...
import 'package:abcegitim/CiftciTr.dart';
import 'package:flutter/material.dart';
import 'TamirciTr.dart';
import 'anasayfa.dart';

class ItfaiyeciTr extends StatefulWidget {
  const ItfaiyeciTr({Key? key}) : super(key: key);

  @override
  _ItfaiyeciTrState createState() => _ItfaiyeciTrState();
}

class _ItfaiyeciTrState extends State<ItfaiyeciTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              ...
              child: const Text('İTFAİYECİ',style: TextStyle(fontWeight: FontWeight.bold,
