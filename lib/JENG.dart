...
import 'IENG.dart';
import 'KENG.dart';
class Jeng extends StatefulWidget {
  const Jeng({Key? key}) : super(key: key);

  @override
  _JengState createState() => _JengState();
}

class _JengState extends State<Jeng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/j.png'),),
              onTap: (){player.play('jen.mp3');},
            ),
