...
import 'package:abcegitim/J.dart';
import 'package:abcegitim/anasayfa.dart';
import 'package:flutter/material.dart';
import 'L.dart';

class Ktr extends StatefulWidget {
  const Ktr({Key? key}) : super(key: key);

  @override
  _KtrState createState() => _KtrState();
}

class _KtrState extends State<Ktr> {
