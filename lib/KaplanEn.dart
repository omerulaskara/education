...
import 'KaplumEn.dart';
import 'anasayfa.dart';

class KaplanEn extends StatefulWidget {
  const KaplanEn({Key? key}) : super(key: key);

  @override
  _KaplanEnState createState() => _KaplanEnState();
}

class _KaplanEnState extends State<KaplanEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/kaplan.png'),),
          ...
          Container(
              ...
              child: const Text('TIGER',style: TextStyle(fontWeight: FontWeight.bold,
