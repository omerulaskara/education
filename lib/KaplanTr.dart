...
class KaplanTr extends StatefulWidget {
  const KaplanTr({Key? key}) : super(key: key);

  @override
  _KaplanTrState createState() => _KaplanTrState();
}

class _KaplanTrState extends State<KaplanTr> {
