...
import 'KarincaEn.dart';
import 'anasayfa.dart';

class KaplumEn extends StatefulWidget {
  const KaplumEn({Key? key}) : super(key: key);

  @override
  _KaplumEnState createState() => _KaplumEnState();
}

class _KaplumEnState extends State<KaplumEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'TORTOISE', style: TextStyle(fontWeight: FontWeight.bold,
