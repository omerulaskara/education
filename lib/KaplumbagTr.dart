...
class KaplumbagTr extends StatefulWidget {
  const KaplumbagTr({Key? key}) : super(key: key);

  @override
  _KaplumbagTrState createState() => _KaplumbagTrState();
}

class _KaplumbagTrState extends State<KaplumbagTr> {
