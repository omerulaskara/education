...
class KarincaEn extends StatefulWidget {
  const KarincaEn({Key? key}) : super(key: key);

  @override
  _KarincaEnState createState() => _KarincaEnState();
}

class _KarincaEnState extends State<KarincaEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('ANT',style: TextStyle(fontWeight: FontWeight.bold,
