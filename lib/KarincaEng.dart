...
import 'KaplumbagEng.dart';
import 'KediEng.dart';

class KarincaEng extends StatefulWidget {
  const KarincaEng({Key? key}) : super(key: key);

  @override
  _KarincaEngState createState() => _KarincaEngState();
}

class _KarincaEngState extends State<KarincaEng> {
