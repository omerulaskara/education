...
class KarincaT extends StatefulWidget {
  const KarincaT({Key? key}) : super(key: key);

  @override
  _KarincaTState createState() => _KarincaTState();
}

class _KarincaTState extends State<KarincaT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'KARINCA', style: TextStyle(fontWeight: FontWeight.bold,
