...
class KediEn extends StatefulWidget {
  const KediEn({Key? key}) : super(key: key);

  @override
  _KediEnState createState() => _KediEnState();
}

class _KediEnState extends State<KediEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('CAT',style: TextStyle(fontWeight: FontWeight.bold,
