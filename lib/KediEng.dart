...
import 'KelebekEng.dart';

class KediEng extends StatefulWidget {
  const KediEng({Key? key}) : super(key: key);

  @override
  _KediEngState createState() => _KediEngState();
}

class _KediEngState extends State<KediEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/kedi.png'),),
