...
import 'KarincaTr.dart';
import 'KelebekTr.dart';

class KediTr extends StatefulWidget {
  const KediTr({Key? key}) : super(key: key);

  @override
  _KediTrState createState() => _KediTrState();
}

class _KediTrState extends State<KediTr> {
