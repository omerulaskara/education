...
class KelebekEn extends StatefulWidget {
  const KelebekEn({Key? key}) : super(key: key);

  @override
  _KelebekEnState createState() => _KelebekEnState();
}

class _KelebekEnState extends State<KelebekEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('BUTTERFLY',style: TextStyle(fontWeight: FontWeight.bold,
