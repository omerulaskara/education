...
class KelebekTr extends StatefulWidget {
  const KelebekTr({Key? key}) : super(key: key);

  @override
  _KelebekTrState createState() => _KelebekTrState();
}

class _KelebekTrState extends State<KelebekTr> {
