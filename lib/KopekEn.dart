...
import 'KelebekEn.dart';
import 'KurtEn.dart';
import 'anasayfa.dart';

class KopekEn extends StatefulWidget {
  const KopekEn({Key? key}) : super(key: key);

  @override
  _KopekEnState createState() => _KopekEnState();
}

class _KopekEnState extends State<KopekEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('DOG',style: TextStyle(fontWeight: FontWeight.bold,
