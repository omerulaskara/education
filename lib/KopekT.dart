...
class KopekT extends StatefulWidget {
  const KopekT({Key? key}) : super(key: key);

  @override
  _KopekTState createState() => _KopekTState();
}

class _KopekTState extends State<KopekT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'KÖPEK', style: TextStyle(fontWeight: FontWeight.bold,
