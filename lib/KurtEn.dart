...
class KurtEn extends StatefulWidget {
  const KurtEn({Key? key}) : super(key: key);

  @override
  _KurtEnState createState() => _KurtEnState();
}

class _KurtEnState extends State<KurtEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('WOLF',style: TextStyle(fontWeight: FontWeight.bold,
