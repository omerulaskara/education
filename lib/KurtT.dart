...
class KurtT extends StatefulWidget {
  const KurtT({Key? key}) : super(key: key);

  @override
  _KurtTState createState() => _KurtTState();
}

class _KurtTState extends State<KurtT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'KURT', style: TextStyle(fontWeight: FontWeight.bold,
