...
class KusEn extends StatefulWidget {
  const KusEn({Key? key}) : super(key: key);

  @override
  _KusEnState createState() => _KusEnState();
}

class _KusEnState extends State<KusEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/kus.png'),),
          ...
          Container(
              ...
              child: const Text('BIRD',style: TextStyle(fontWeight: FontWeight.bold,
