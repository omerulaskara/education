...
class KusT extends StatefulWidget {
  const KusT({Key? key}) : super(key: key);

  @override
  _KusTState createState() => _KusTState();
}

class _KusTState extends State<KusT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'KUŞ', style: TextStyle(fontWeight: FontWeight.bold,
