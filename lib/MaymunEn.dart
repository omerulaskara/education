...
class MaymunEn extends StatefulWidget {
  const MaymunEn({Key? key}) : super(key: key);

  @override
  _MaymunEnState createState() => _MaymunEnState();
}

class _MaymunEnState extends State<MaymunEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/maymun.png'),),
          ...
          Container(
              ...
              child: const Text('MONKEY',style: TextStyle(fontWeight: FontWeight.bold,
