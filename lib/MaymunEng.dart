...
import 'KusEng.dart';
import 'OrumcekEng.dart';

class MaymunEng extends StatefulWidget {
  const MaymunEng({Key? key}) : super(key: key);

  @override
  _MaymunEngState createState() => _MaymunEngState();
}

class _MaymunEngState extends State<MaymunEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/maymun.png'),),
