...
import 'KusTr.dart';
import 'OrumcekTr.dart';

class MaymunTr extends StatefulWidget {
  const MaymunTr({Key? key}) : super(key: key);

  @override
  _MaymunTrState createState() => _MaymunTrState();
}

class _MaymunTrState extends State<MaymunTr> {
