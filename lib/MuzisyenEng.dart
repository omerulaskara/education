...
class MuzisyenEng extends StatefulWidget {
  const MuzisyenEng({Key? key}) : super(key: key);

  @override
  _MuzisyenEngState createState() => _MuzisyenEngState();
}

class _MuzisyenEngState extends State<MuzisyenEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('MUSICIAN',style: TextStyle(fontWeight: FontWeight.bold,
