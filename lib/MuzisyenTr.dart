...
class MuzisyenTr extends StatefulWidget {
  const MuzisyenTr({Key? key}) : super(key: key);

  @override
  _MuzisyenTrState createState() => _MuzisyenTrState();
}

class _MuzisyenTrState extends State<MuzisyenTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/muzisyen.png'),),
          ...
          Container(
              ...
              child: const Text('MÜZİSYEN',style: TextStyle(fontWeight: FontWeight.bold,
