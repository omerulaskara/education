...
class Ntr extends StatefulWidget {
  const Ntr({Key? key}) : super(key: key);

  @override
  _NtrState createState() => _NtrState();
}

class _NtrState extends State<Ntr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/n.png'),),
              onTap: (){player.play('n.mp3');},
            ),
