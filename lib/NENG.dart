...
import 'MENG.dart';
import 'OENG.dart';
class Neng extends StatefulWidget {
  const Neng({Key? key}) : super(key: key);

  @override
  _NengState createState() => _NengState();
}

class _NengState extends State<Neng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/n.png'),),
              onTap: (){player.play('nen.mp3');},
            ),
