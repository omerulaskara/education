...
class OOtr extends StatefulWidget {
  const OOtr({Key? key}) : super(key: key);

  @override
  _OOtrState createState() => _OOtrState();
}

class _OOtrState extends State<OOtr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/oo.png'),),
              onTap: (){player.play('oo.mp3');},
            ),
