...
import 'B.dart';
import 'DoktorEng.dart';
import 'anasayfa.dart';

class OgretmenEng extends StatefulWidget {
  const OgretmenEng({Key? key}) : super(key: key);

  @override
  _OgretmenEngState createState() => _OgretmenEngState();
}

class _OgretmenEngState extends State<OgretmenEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/ogret.png'),),
          ...
          Container(
            ...
            child: const Text('TEACHER',style: TextStyle(fontWeight: FontWeight.bold,
