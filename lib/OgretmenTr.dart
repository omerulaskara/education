...
import 'B.dart';
import 'DoktorTr.dart';
import 'anasayfa.dart';

class OgretmenTr extends StatefulWidget {
  const OgretmenTr({Key? key}) : super(key: key);

  @override
  _OgretmenTrState createState() => _OgretmenTrState();
}

class _OgretmenTrState extends State<OgretmenTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text('ÖĞRETMEN',style: TextStyle(fontWeight: FontWeight.bold,
