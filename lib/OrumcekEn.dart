...
import 'MaymunEn.dart';
import 'PandaEn.dart';
import 'anasayfa.dart';

class OrumcekEn extends StatefulWidget {
  const OrumcekEn({Key? key}) : super(key: key);

  @override
  _OrumcekEnState createState() => _OrumcekEnState();
}

class _OrumcekEnState extends State<OrumcekEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/orumcek.png'),),
          ...
          Container(
              ...
              child: const Text('SPIDER',style: TextStyle(fontWeight: FontWeight.bold,
