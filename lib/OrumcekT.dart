...
class OrumcekT extends StatefulWidget {
  const OrumcekT({Key? key}) : super(key: key);

  @override
  _OrumcekTState createState() => _OrumcekTState();
}

class _OrumcekTState extends State<OrumcekT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'ÖRÜMCEK', style: TextStyle(fontWeight: FontWeight.bold,
