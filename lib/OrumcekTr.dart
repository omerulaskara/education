...
import 'MaymunTr.dart';
import 'PandaTr.dart';

class OrumcekTr extends StatefulWidget {
  const OrumcekTr({Key? key}) : super(key: key);

  @override
  _OrumcekTrState createState() => _OrumcekTrState();
}

class _OrumcekTrState extends State<OrumcekTr> {
