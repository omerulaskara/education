...
import 'OrumcekEn.dart';
import 'PapaganEn.dart';
import 'anasayfa.dart';

class PandaEn extends StatefulWidget {
  const PandaEn({Key? key}) : super(key: key);

  @override
  _PandaEnState createState() => _PandaEnState();
}

class _PandaEnState extends State<PandaEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/panda.png'),),
          ...
          Container(
              ...
              child: const Text('PANDA',style: TextStyle(fontWeight: FontWeight.bold,
