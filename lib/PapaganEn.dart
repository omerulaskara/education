...
class PapaganEn extends StatefulWidget {
  const PapaganEn({Key? key}) : super(key: key);

  @override
  _PapaganEnState createState() => _PapaganEnState();
}

class _PapaganEnState extends State<PapaganEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('PARROT',style: TextStyle(fontWeight: FontWeight.bold,
