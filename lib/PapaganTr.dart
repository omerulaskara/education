...
class PapaganTr extends StatefulWidget {
  const PapaganTr({Key? key}) : super(key: key);

  @override
  _PapaganTrState createState() => _PapaganTrState();
}

class _PapaganTrState extends State<PapaganTr> {
