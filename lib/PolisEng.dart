...
import 'package:abcegitim/PilotEng.dart';
import 'package:flutter/material.dart';

import 'B.dart';
import 'anasayfa.dart';

class PolisEng extends StatefulWidget {
  const PolisEng({Key? key}) : super(key: key);

  @override
  _PolisEngState createState() => _PolisEngState();
}

class _PolisEngState extends State<PolisEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/polis.png'),),
          ...
          Container(
              ...
              child: const Text('POLİCE',style: TextStyle(fontWeight: FontWeight.bold,
