...
import 'package:abcegitim/PilotTr.dart';
import 'package:flutter/material.dart';

import 'B.dart';
import 'anasayfa.dart';

class PolisTr extends StatefulWidget {
  const PolisTr({Key? key}) : super(key: key);

  @override
  _PolisTrState createState() => _PolisTrState();
}

class _PolisTrState extends State<PolisTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('POLİS',style: TextStyle(fontWeight: FontWeight.bold,
