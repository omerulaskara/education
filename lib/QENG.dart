...
import 'PENG.dart';
import 'RENG.dart';
class Qeng extends StatefulWidget {
  const Qeng({Key? key}) : super(key: key);

  @override
  _QengState createState() => _QengState();
}

class _QengState extends State<Qeng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/q.png'),),
              onTap: (){player.play('qen.mp3');},
            ),
