...
import 'B.dart';
import 'CiftciTr.dart';
import 'BirTr.dart';
import 'TamirciTr.dart';
import 'anasayfa.dart';

class RessamTr extends StatefulWidget {
  const RessamTr({Key? key}) : super(key: key);

  @override
  _RessamTrState createState() => _RessamTrState();
}

class _RessamTrState extends State<RessamTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('RESSAM',style: TextStyle(fontWeight: FontWeight.bold,
