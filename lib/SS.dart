...
class SStr extends StatefulWidget {
  const SStr({Key? key}) : super(key: key);

  @override
  _SStrState createState() => _SStrState();
}

class _SStrState extends State<SStr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/ss.png'),),
              onTap: (){player.play('ss.mp3');},
            ),
