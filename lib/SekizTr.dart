...
class SekizTr extends StatefulWidget {
  const SekizTr({Key? key}) : super(key: key);

  @override
  _SekizTrState createState() => _SekizTrState();
}

class _SekizTrState extends State<SekizTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/sekiz.png'),),
          ...
          SizedBox(
              ...
              child: const Text('SEKİZ',style: TextStyle(fontWeight: FontWeight.bold,
