...
class SifirTr extends StatefulWidget {
  const SifirTr({Key? key}) : super(key: key);

  @override
  _SifirTrState createState() => _SifirTrState();
}

class _SifirTrState extends State<SifirTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/sifir.png'),),
          ...
          SizedBox(
              ...
              child: const Text('SIFIR',style: TextStyle(fontWeight: FontWeight.bold,
