...
import 'PapaganEn.dart';
import 'TavsanEn.dart';
import 'anasayfa.dart';

class SincapEn extends StatefulWidget {
  const SincapEn({Key? key}) : super(key: key);

  @override
  _SincapEnState createState() => _SincapEnState();
}

class _SincapEnState extends State<SincapEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/sincap.png'),),
          ...
          Container(
              ...
              child: const Text('SQUIRREL',style: TextStyle(fontWeight: FontWeight.bold,
