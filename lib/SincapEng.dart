...
import 'PapaganEng.dart';
import 'TavsanEng.dart';

class SincapEng extends StatefulWidget {
  const SincapEng({Key? key}) : super(key: key);

  @override
  _SincapEngState createState() => _SincapEngState();
}

class _SincapEngState extends State<SincapEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/sincap.png'),),
