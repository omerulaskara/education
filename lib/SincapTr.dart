...
import 'PapaganTr.dart';
import 'TavsanTr.dart';

class SincapTr extends StatefulWidget {
  const SincapTr({Key? key}) : super(key: key);

  @override
  _SincapTrState createState() => _SincapTrState();
}

class _SincapTrState extends State<SincapTr> {
