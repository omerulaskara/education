...
import 'package:abcegitim/ItfaiyeciTr.dart';
...
class TamirciTr extends StatefulWidget {
  const TamirciTr({Key? key}) : super(key: key);

  @override
  _TamirciTrState createState() => _TamirciTrState();
}

class _TamirciTrState extends State<TamirciTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('TAMİRCİ',style: TextStyle(fontWeight: FontWeight.bold,
