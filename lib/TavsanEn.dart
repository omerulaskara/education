...
import 'SincapEn.dart';
import 'TavukEn.dart';
import 'anasayfa.dart';

class TavsanEn extends StatefulWidget {
  const TavsanEn({Key? key}) : super(key: key);

  @override
  _TavsanEnState createState() => _TavsanEnState();
}

class _TavsanEnState extends State<TavsanEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/tavsan.png'),),
          ...
          Container(
              ...
              child: const Text('RABBIT',style: TextStyle(fontWeight: FontWeight.bold,
