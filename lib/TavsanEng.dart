...
class TavsanEng extends StatefulWidget {
  const TavsanEng({Key? key}) : super(key: key);

  @override
  _TavsanEngState createState() => _TavsanEngState();
}

class _TavsanEngState extends State<TavsanEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/tavsan.png'),),
          ...
          Container(
            height: screenheight/4,
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/r.png'),),
              onTap: (){player.play('a.mp3');},
            ),
