...
class TavsanT extends StatefulWidget {
  const TavsanT({Key? key}) : super(key: key);

  @override
  _TavsanTState createState() => _TavsanTState();
}

class _TavsanTState extends State<TavsanT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'TAVŞAN', style: TextStyle(fontWeight: FontWeight.bold,
