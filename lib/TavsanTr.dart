...
import 'SincapTr.dart';
import 'TavukTr.dart';

class TavsanTr extends StatefulWidget {
  const TavsanTr({Key? key}) : super(key: key);

  @override
  _TavsanTrState createState() => _TavsanTrState();
}

class _TavsanTrState extends State<TavsanTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: screenheight/4,
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/t.png'),),
              onTap: (){player.play('a.mp3');},
            ),
