...
class TavukEn extends StatefulWidget {
  const TavukEn({Key? key}) : super(key: key);

  @override
  _TavukEnState createState() => _TavukEnState();
}

class _TavukEnState extends State<TavukEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('CHICKEN',style: TextStyle(fontWeight: FontWeight.bold,
