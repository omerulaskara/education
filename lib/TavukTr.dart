...
import 'TavsanTr.dart';
import 'TilkiTr.dart';

class TavukTr extends StatefulWidget {
  const TavukTr({Key? key}) : super(key: key);

  @override
  _TavukTrState createState() => _TavukTrState();
}

class _TavukTrState extends State<TavukTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/tavuk.png'),),
