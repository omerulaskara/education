...
import 'TavukEn.dart';
import 'TimsahEn.dart';
import 'anasayfa.dart';

class TilkiEn extends StatefulWidget {
  const TilkiEn({Key? key}) : super(key: key);

  @override
  _TilkiEnState createState() => _TilkiEnState();
}

class _TilkiEnState extends State<TilkiEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/tilki.png'),),
          ...
          Container(
              ...
              child: const Text('FOX',style: TextStyle(fontWeight: FontWeight.bold,
