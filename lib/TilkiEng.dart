...
import 'TavukEng.dart';
import 'TimsahEng.dart';

class TilkiEng extends StatefulWidget {
  const TilkiEng({Key? key}) : super(key: key);

  @override
  _TilkiEngState createState() => _TilkiEngState();
}

class _TilkiEngState extends State<TilkiEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/tilki.png'),),
          ...
          Container(
            height: screenheight/4,
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/f.png'),),
              onTap: (){player.play('a.mp3');},
            ),
