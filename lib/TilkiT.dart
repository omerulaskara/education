...
class TilkiT extends StatefulWidget {
  const TilkiT({Key? key}) : super(key: key);

  @override
  _TilkiTState createState() => _TilkiTState();
}

class _TilkiTState extends State<TilkiT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'TİLKİ', style: TextStyle(fontWeight: FontWeight.bold,
