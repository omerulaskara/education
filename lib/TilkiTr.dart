...
class TilkiTr extends StatefulWidget {
  const TilkiTr({Key? key}) : super(key: key);

  @override
  _TilkiTrState createState() => _TilkiTrState();
}

class _TilkiTrState extends State<TilkiTr> {
