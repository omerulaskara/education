...
class TimsahEn extends StatefulWidget {
  const TimsahEn({Key? key}) : super(key: key);

  @override
  _TimsahEnState createState() => _TimsahEnState();
}

class _TimsahEnState extends State<TimsahEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/timsah.png'),),
          ...
          Container(
              ...
              child: const Text('CROCODILE',style: TextStyle(fontWeight: FontWeight.bold,
