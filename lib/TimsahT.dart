...
class TimsahT extends StatefulWidget {
  const TimsahT({Key? key}) : super(key: key);

  @override
  _TimsahTState createState() => _TimsahTState();
}

class _TimsahTState extends State<TimsahT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'TİMSAH', style: TextStyle(fontWeight: FontWeight.bold,
