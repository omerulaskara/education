...
class TimsahTr extends StatefulWidget {
  const TimsahTr({Key? key}) : super(key: key);

  @override
  _TimsahTrState createState() => _TimsahTrState();
}

class _TimsahTrState extends State<TimsahTr> {
