...
import 'package:abcegitim/C.dart';
...
class UUtr extends StatefulWidget {
  const UUtr({Key? key}) : super(key: key);

  @override
  _UUtrState createState() => _UUtrState();
}

class _UUtrState extends State<UUtr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/uu.png'),),
              onTap: (){player.play('uu.mp3');},
            ),
