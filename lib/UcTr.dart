...
class UcTr extends StatefulWidget {
  const UcTr({Key? key}) : super(key: key);

  @override
  _UcTrState createState() => _UcTrState();
}

class _UcTrState extends State<UcTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/uc.png'),),
          ...
          SizedBox(
              ...
              child: const Text('ÜÇ',style: TextStyle(fontWeight: FontWeight.bold,
