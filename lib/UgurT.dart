...
class UgurT extends StatefulWidget {
  const UgurT({Key? key}) : super(key: key);

  @override
  _UgurTState createState() => _UgurTState();
}

class _UgurTState extends State<UgurT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/ugur.png'),),
              onTap: () {
                player.play('a.mp3');
              },
            ),
          ...
          Container(
              ...
              child: const Text(
                'UĞUR BÖCEĞİ', style: TextStyle(fontWeight: FontWeight.bold,
