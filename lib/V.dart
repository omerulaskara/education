...
class Vtr extends StatefulWidget {
  const Vtr({Key? key}) : super(key: key);

  @override
  _VtrState createState() => _VtrState();
}

class _VtrState extends State<Vtr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/v.png'),),
              onTap: (){player.play('v.mp3');},
            ),
