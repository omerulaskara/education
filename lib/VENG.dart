...
import 'UENG.dart';
import 'WENG.dart';
class Veng extends StatefulWidget {
  const Veng({Key? key}) : super(key: key);

  @override
  _VengState createState() => _VengState();
}

class _VengState extends State<Veng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/v.png'),),
              onTap: (){player.play('ven.mp3');},
            ),
