...
import 'WENG.dart';
import 'YENG.dart';
class Xeng extends StatefulWidget {
  const Xeng({Key? key}) : super(key: key);

  @override
  _XengState createState() => _XengState();
}

class _XengState extends State<Xeng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/x.png'),),
              onTap: (){player.play('xen.mp3');},
            ),
