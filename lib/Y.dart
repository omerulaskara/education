...
class Ytr extends StatefulWidget {
  const Ytr({Key? key}) : super(key: key);

  @override
  _YtrState createState() => _YtrState();
}

class _YtrState extends State<Ytr> {
