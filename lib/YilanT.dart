...
class YilanT extends StatefulWidget {
  const YilanT({Key? key}) : super(key: key);

  @override
  _YilanTState createState() => _YilanTState();
}

class _YilanTState extends State<YilanT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'YILAN', style: TextStyle(fontWeight: FontWeight.bold,
