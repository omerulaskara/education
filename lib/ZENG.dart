...
import 'YENG.dart';
class Zeng extends StatefulWidget {
  const Zeng({Key? key}) : super(key: key);

  @override
  _ZengState createState() => _ZengState();
}

class _ZengState extends State<Zeng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            width: screenwidth,
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/z.png'),),
              onTap: (){player.play('zen.mp3');},
            ),
