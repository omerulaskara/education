...
import 'YilanEn.dart';
import 'ZurafaEn.dart';
import 'anasayfa.dart';

class ZebraEn extends StatefulWidget {
  const ZebraEn({Key? key}) : super(key: key);

  @override
  _ZebraEnState createState() => _ZebraEnState();
}

class _ZebraEnState extends State<ZebraEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/zebra.png'),),
          ...
          Container(
              ...
              child: const Text('ZEBRA',style: TextStyle(fontWeight: FontWeight.bold,
