...
class ZebraT extends StatefulWidget {
  const ZebraT({Key? key}) : super(key: key);

  @override
  _ZebraTState createState() => _ZebraTState();
}

class _ZebraTState extends State<ZebraT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'ZEBRA', style: TextStyle(fontWeight: FontWeight.bold,
