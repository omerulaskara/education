...
import 'ZebraEng.dart';
class ZurafaEng extends StatefulWidget {
  const ZurafaEng({Key? key}) : super(key: key);

  @override
  _ZurafaEngState createState() => _ZurafaEngState();
}

class _ZurafaEngState extends State<ZurafaEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: Image(image: AssetImage('assets/images/zurafa.png'),),
