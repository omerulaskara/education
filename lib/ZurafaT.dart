...
class ZurafaT extends StatefulWidget {
  const ZurafaT({Key? key}) : super(key: key);

  @override
  _ZurafaTState createState() => _ZurafaTState();
}

class _ZurafaTState extends State<ZurafaT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'ZÜRAFA', style: TextStyle(fontWeight: FontWeight.bold,
