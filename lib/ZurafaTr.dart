...
import 'ZebraTr.dart';
class ZurafaTr extends StatefulWidget {
  const ZurafaTr({Key? key}) : super(key: key);

  @override
  _ZurafaTrState createState() => _ZurafaTrState();
}

class _ZurafaTrState extends State<ZurafaTr> {
