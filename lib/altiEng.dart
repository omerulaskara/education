...
class altiEng extends StatefulWidget {
  const altiEng({Key? key}) : super(key: key);

  @override
  _altiEngState createState() => _altiEngState();
}

class _altiEngState extends State<altiEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/alti.png'),fit: BoxFit.cover),
          ...
          SizedBox(
              ...
              child: const Text('SİX',style: TextStyle(fontWeight: FontWeight.bold,
