...
import 'package:abcegitim/ItfaeEng.dart';

import 'AstronotEng.dart';
import 'anasayfa.dart';

class BankEng extends StatefulWidget {
  const BankEng({Key? key}) : super(key: key);

  @override
  _BankEngState createState() => _BankEngState();
}

class _BankEngState extends State<BankEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('BANK',style: TextStyle(fontWeight: FontWeight.bold,
