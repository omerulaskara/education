...
class camiEng extends StatefulWidget {
  const camiEng({Key? key}) : super(key: key);

  @override
  _camiEngState createState() => _camiEngState();
}

class _camiEngState extends State<camiEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/cami.png'),),
          ...
          Container(
              ...
              child: const Text('MOSQUE',style: TextStyle(fontWeight: FontWeight.bold,
