...
class camiTr extends StatefulWidget {
  const camiTr({Key? key}) : super(key: key);

  @override
  _camiTrState createState() => _camiTrState();
}

class _camiTrState extends State<camiTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('CAMİ',style: TextStyle(fontWeight: FontWeight.bold,
