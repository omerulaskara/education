...
import 'SekizEng.dart';
import 'anasayfa.dart';

class dokuzEng extends StatefulWidget {
  const dokuzEng({Key? key}) : super(key: key);

  @override
  _dokuzEngState createState() => _dokuzEngState();
}

class _dokuzEngState extends State<dokuzEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/dokuz.png'),fit: BoxFit.cover),
          ...
          SizedBox(
              ...
              child: const Text('NINE',style: TextStyle(fontWeight: FontWeight.bold,
