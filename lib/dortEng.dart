...
class dortEng extends StatefulWidget {
  const dortEng({Key? key}) : super(key: key);

  @override
  _dortEngState createState() => _dortEngState();
}

class _dortEngState extends State<dortEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/dort.png'),),
          ...
          SizedBox(
              ...
              child: const Text('FOUR',style: TextStyle(fontWeight: FontWeight.bold,
