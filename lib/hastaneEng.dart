...
class hastaneEng extends StatefulWidget {
  const hastaneEng({Key? key}) : super(key: key);

  @override
  _hastaneEngState createState() => _hastaneEngState();
}

class _hastaneEngState extends State<hastaneEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/hastane.png'),),
          ...
          Container(
              ...
              child: const Text('HOSPITAL',style: TextStyle(fontWeight: FontWeight.bold,
