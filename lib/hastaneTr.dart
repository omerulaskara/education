...
class hastaneTr extends StatefulWidget {
  const hastaneTr({Key? key}) : super(key: key);

  @override
  _hastaneTrState createState() => _hastaneTrState();
}

class _hastaneTrState extends State<hastaneTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('hastane',style: TextStyle(fontWeight: FontWeight.bold,
