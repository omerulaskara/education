...
import 'hastaneEng.dart';
import 'karakolEng.dart';

class hayvanatEng extends StatefulWidget {
  const hayvanatEng({Key? key}) : super(key: key);

  @override
  _hayvanatEngState createState() => _hayvanatEngState();
}

class _hayvanatEngState extends State<hayvanatEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('ZOO',style: TextStyle(fontWeight: FontWeight.bold,
