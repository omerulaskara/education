...
import 'hastaneTr.dart';
import 'karakolTr.dart';

class hayvanatTr extends StatefulWidget {
  const hayvanatTr({Key? key}) : super(key: key);

  @override
  _hayvanatTrState createState() => _hayvanatTrState();
}

class _hayvanatTrState extends State<hayvanatTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/hayvanat.png'),),
          ...
          Container(
              ...
              child: const Text('HAYVANAT BAHÇESİ',style: TextStyle(fontWeight: FontWeight.bold,
