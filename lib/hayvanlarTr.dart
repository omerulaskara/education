...
class HayvanlarTr extends StatefulWidget {
  const HayvanlarTr({Key? key}) : super(key: key);

  @override
  _HayvanlarTrState createState() => _HayvanlarTrState();
}

class _HayvanlarTrState extends State<HayvanlarTr> {
                  ...
                  child: Row(
                    ...
                    children: [
                      const Padding(padding: EdgeInsets.only(left: 10),
                        child: Text('HAYVANLAR', style: TextStyle(
