...
class ikiEng extends StatefulWidget {
  const ikiEng({Key? key}) : super(key: key);

  @override
  _ikiEngState createState() => _ikiEngState();
}

class _ikiEngState extends State<ikiEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/iki.png'),fit: BoxFit.cover),
          ...
          SizedBox(
              ...
              child: const Text('TWO',style: TextStyle(fontWeight: FontWeight.bold,
