...
import 'hayvanatEng.dart';
import 'kutuphaneEng.dart';

class karakolEng extends StatefulWidget {
  const karakolEng({Key? key}) : super(key: key);

  @override
  _karakolEngState createState() => _karakolEngState();
}

class _karakolEngState extends State<karakolEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('POLICE STATION',style: TextStyle(fontWeight: FontWeight.bold,
