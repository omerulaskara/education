...
import 'hayvanatTr.dart';
import 'kutuphaneTr.dart';

class karakolTr extends StatefulWidget {
  const karakolTr({Key? key}) : super(key: key);

  @override
  _karakolTrState createState() => _karakolTrState();
}

class _karakolTrState extends State<karakolTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/karakol.png'),),
          ...
          Container(
              ...
              child: const Text('karakol',style: TextStyle(fontWeight: FontWeight.bold,
