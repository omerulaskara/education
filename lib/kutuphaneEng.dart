...
import 'karakolEng.dart';
import 'marketEng.dart';

class kutuphaneEng extends StatefulWidget {
  const kutuphaneEng({Key? key}) : super(key: key);

  @override
  _kutuphaneEngState createState() => _kutuphaneEngState();
}

class _kutuphaneEngState extends State<kutuphaneEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/kutuphane.png'),),
          ...
          Container(
              ...
              child: const Text('LIBRARY',style: TextStyle(fontWeight: FontWeight.bold,
