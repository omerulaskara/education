...
import 'marketTr.dart';

class kutuphaneTr extends StatefulWidget {
  const kutuphaneTr({Key? key}) : super(key: key);

  @override
  _kutuphaneTrState createState() => _kutuphaneTrState();
}

class _kutuphaneTrState extends State<kutuphaneTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('KÜTÜPHANE',style: TextStyle(fontWeight: FontWeight.bold,
