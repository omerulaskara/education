...
class marketTr extends StatefulWidget {
  const marketTr({Key? key}) : super(key: key);

  @override
  _marketTrState createState() => _marketTrState();
}

class _marketTrState extends State<marketTr> {
