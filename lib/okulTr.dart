...
class okulTr extends StatefulWidget {
  const okulTr({Key? key}) : super(key: key);

  @override
  _okulTrState createState() => _okulTrState();
}

class _okulTrState extends State<okulTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('okul',style: TextStyle(fontWeight: FontWeight.bold,
