...
import 'package:abcegitim/pastaneTr.dart';

import 'AstronotTr.dart';
import 'anasayfa.dart';
import 'marketTr.dart';

class parkTr extends StatefulWidget {
  const parkTr({Key? key}) : super(key: key);

  @override
  _parkTrState createState() => _parkTrState();
}

class _parkTrState extends State<parkTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/park.png'),),
          ...
          Container(
              ...
              child: const Text('park',style: TextStyle(fontWeight: FontWeight.bold,
