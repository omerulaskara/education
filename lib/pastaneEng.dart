...
class pastaneEng extends StatefulWidget {
  const pastaneEng({Key? key}) : super(key: key);

  @override
  _pastaneEngState createState() => _pastaneEngState();
}

class _pastaneEngState extends State<pastaneEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/pastane.png'),),
          ...
          Container(
              ...
              child: const Text('PATISSERIE',style: TextStyle(fontWeight: FontWeight.bold,
