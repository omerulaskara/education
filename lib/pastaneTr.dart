...
class pastaneTr extends StatefulWidget {
  const pastaneTr({Key? key}) : super(key: key);

  @override
  _pastaneTrState createState() => _pastaneTrState();
}

class _pastaneTrState extends State<pastaneTr> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('pastane',style: TextStyle(fontWeight: FontWeight.bold,
