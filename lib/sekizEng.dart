...
import 'DokuzEng.dart';
import 'PilotEng.dart';
import 'YediEng.dart';
import 'anasayfa.dart';

class sekizEng extends StatefulWidget {
  const sekizEng({Key? key}) : super(key: key);

  @override
  _sekizEngState createState() => _sekizEngState();
}

class _sekizEngState extends State<sekizEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/sekiz.png'),fit: BoxFit.cover),
          ...
          SizedBox(
              ...
              child: const Text('EIGHT',style: TextStyle(fontWeight: FontWeight.bold,
