...
class sifirEng extends StatefulWidget {
  const sifirEng({Key? key}) : super(key: key);

  @override
  _sifirEngState createState() => _sifirEngState();
}

class _sifirEngState extends State<sifirEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/sifir.png'),fit: BoxFit.cover,),
          ...
          SizedBox(
              ...
              child: const Text('ZERO',style: TextStyle(fontWeight: FontWeight.bold,
