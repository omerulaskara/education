...
class yediEng extends StatefulWidget {
  const yediEng({Key? key}) : super(key: key);

  @override
  _yediEngState createState() => _yediEngState();
}

class _yediEngState extends State<yediEng> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: GestureDetector(
              child: const Image(image: AssetImage('assets/images/yedi.png'),fit: BoxFit.cover),
          ...
          SizedBox(
              ...
              child: const Text('SEVEN',style: TextStyle(fontWeight: FontWeight.bold,
