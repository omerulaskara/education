...
import 'KaplanEn.dart';
import 'anasayfa.dart';

class InekEn extends StatefulWidget {
  const InekEn({Key? key}) : super(key: key);

  @override
  _InekEnState createState() => _InekEnState();
}

class _InekEnState extends State<InekEn> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text('COW',style: TextStyle(fontWeight: FontWeight.bold,
