...
import 'GergedanT.dart';
import 'KaplanT.dart';
import 'anasayfa.dart';

class InekT extends StatefulWidget {
  const InekT({Key? key}) : super(key: key);

  @override
  _InekTState createState() => _InekTState();
}

class _InekTState extends State<InekT> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: const Text(
                'İNEK', style: TextStyle(fontWeight: FontWeight.bold,
